...
# general_folder = r'/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd/Images' 
general_folder = r'/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd2/Images'        # Ben added 2nd test set
#general_folder = r'/work/sr365/LVAD_data/KI67DataTests/KI67_images/Validation_Ims_bg2'      # Ben added validation set test
...
#SAVE_ROOT = os.path.join(r'/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd/object_pr_output_val')
SAVE_ROOT = os.path.join(r'/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd2/object_pr_output_val')
#SAVE_ROOT = os.path.join(r'/work/sr365/LVAD_data/KI67DataTests/KI67_images/Validation_Ims_bg2/confidence_map')
...
def infer_confidence_map(DATA_DIR=DATA_DIR, SAVE_ROOT=SAVE_ROOT, FILE_LIST=FILE_LIST,
    ...
    """
    MODEL_maindir =  r'/work/sr365/LVAD_data/KI67DataTests/'
    ...
    # Ben debugging without inferring each time
...
def plot_PR_curve(min_region, dilation_size, link_r, min_th, iou_th, conf_dir_list, tile_name_list, gt_dict, save_title, output_dir, calculate_area=False):
    ...
    for conf_dir in tqdm(conf_dir_list):
        ...
        for tile in tqdm(tile_name_list, desc='Tiles'):
            print('shape of gt file', np.shape(gt_dict[tile]))
            print('shape of conf file', np.shape(conf_dict[tile]))
            print('max of confidence', np.max(conf_dict[tile]))
            print('max of gt', np.max(gt_dict[tile]))
        ...
        print('best_f1_idx = {}, f1={}, p = {}, r = {}, th={}'.format(best_f1_idx, f1[best_f1_idx], p[best_f1_idx], r[best_f1_idx], th[best_f1_idx]))
        print('f1')
        print(f1)
        print('r')
        print(r)
        ...
        #    ap, dilation_size))
        csv_path = '/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd/object_pr_output_val/scores.csv'
        myCsvRow = ",".join([str(f) for f in f1])
        with open(csv_path,'a') as fd:
            fd.write('\n' + 'f1,'+ myCsvRow)
        myCsvRow = ",".join([str(f) for f in r])
        with open(csv_path,'a') as fd:
            fd.write('\n' + 'r,'+ myCsvRow)
        myCsvRow = ",".join([str(f) for f in p])
        with open(csv_path,'a') as fd:
            fd.write('\n' +'p,'+ myCsvRow)
        myCsvRow = ",".join([str(f) for f in th])
        with open(csv_path,'a') as fd:
            fd.write('\n' +'th,'+ myCsvRow)
...
if __name__ == '__main__':
    ...
    # Test set
    #conf_dir_path = os.path.join('/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd/object_pr_output_val/', folder_name,  'pred_masks')
    conf_dir_path = os.path.join('/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd2/object_pr_output_val/', folder_name,  'pred_masks')
    # Validaiton set
    #conf_dir_path = os.path.join('/work/sr365/LVAD_data/KI67DataTests/KI67_images/Validation_Ims_bg2/confidence_map', folder_name,  'pred_masks')
    
    # Test set
    #gt_dir = '/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd/Masks'
    gt_dir = '/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd2/Masks'
    # Valid
    #gt_dir = '/work/sr365/LVAD_data/KI67DataTests/KI67_images/Validation_Masks_bg2'
    
    # Test set
    #output_dir = os.path.join('/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd/object_pr_output_val/', folder_name)
    output_dir = os.path.join('/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd2/object_pr_output_val/', folder_name)
    # Valid set
    #output_dir = os.path.join('/work/sr365/LVAD_data/KI67DataTests/KI67_images/Validation_Ims_bg2/confidence_map', folder_name)
    ...
    #gt_list = [io.imread(os.path.join(gt_dir, f+'_y0x0.png')) for f in tile_name_list]
    gt_list = [io.imread(os.path.join(gt_dir, f+'.tif')) for f in tile_name_list]
    ...
    csv_path = '/work/sr365/LVAD_data/KI67DataTests/KI67_images/TestwAdd/object_pr_output_val/allstats_final.csv'
