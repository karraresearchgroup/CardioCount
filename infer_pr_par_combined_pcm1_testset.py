...
general_folder = r'/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/NewTest/images'
...
SAVE_ROOT = os.path.join(r'/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/NewTest/object_pr_output')
...
def infer_confidence_map(DATA_DIR=DATA_DIR, SAVE_ROOT=SAVE_ROOT, FILE_LIST=FILE_LIST,
    ...
    """
    MODEL_maindir =  r'/usr/project/xtmp/agk21/Karra_LVAD/pcm1models_add/'
...
def plot_PR_curve(min_region, dilation_size, link_r, min_th, iou_th, conf_dir_list, tile_name_list, gt_dict, save_title, output_dir, calculate_area=False):
    ...
    for conf_dir in tqdm(conf_dir_list):
        ...
        #    ap, dilation_size))
        csv_path = '/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/NewTest/object_pr_output/scores.csv'
...
if __name__ == '__main__':
    ...
    conf_dir_path = os.path.join('/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/NewTest/object_pr_output/', folder_name,  'pred_masks')
    
    gt_dir = '/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/NewTest/masks'
    
    output_dir = os.path.join('/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/NewTest/object_pr_output/', folder_name)
    ...
    csv_path = '/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/NewTest/object_pr_output/allstats_final.csv'
