...
"""
import sys
sys.path.insert(0, "/hpc/group/karralab/MLNucSeg/catalyst_project_clean")
# Built-in
import os
...
def get_images(data_dir, valid_percent=0.1, split=False):
    rgb_files = natsorted(glob(os.path.join(data_dir, 'images', '*.tif')))
    lbl_files = natsorted(glob(os.path.join(data_dir, 'annotations', '*.tif')))
...
if __name__ == '__main__':
    ...
    create_dataset(data_dir=r'/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/Train',
                   save_dir=r'/home/home5/agk21/Karra_LVAD_NN/Collins_NeuralNets/PCM1_images/Train', patch_size=(ps, ps), pad=pd, overlap=ol, visualize=False)
