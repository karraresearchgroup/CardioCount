...
general_folder = r'/hpc/group/karralab/test_data/rb_images'

MODEL_DIR = r'/hpc/group/karralab/LVAD_models/erg_rb_opt'

DS_NAME = 'lvad' # Whatever you like to name it
...
general_dir = os.path.join(general_folder, '..')
SAVE_ROOT = os.path.join(general_dir, 'probmap_erg/') # Parent directory of input images in .jpg format
...
if __name__ == '__main__':
    infer_confidence_map(FILE_LIST=os.path.join(DATA_DIR,'file_list_raw.txt'))
